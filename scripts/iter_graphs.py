...
def compute_similarity_s(i, j, S_C, idata, interface_cos_sim, gamma_I):
    similarity = calculate_interface_similarity(interface_i=i, interface_j=j, S_C=S_C, idata=idata, interface_cos_sim=interface_cos_sim, gamma_I=gamma_I)
        ...
        with ThreadPoolExecutor() as executor:
            ...
            for i in range(n):
                for j in range(i + 1, n):
                    futures.append(executor.submit(compute_similarity_s, i, j, S_C, infc_adata, cos_sim_infc, gamma_I))
